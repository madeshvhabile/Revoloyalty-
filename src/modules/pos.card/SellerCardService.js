export default class SellerCardService {
    constructor(Restangular, EditableMap) {
        this.Restangular = Restangular;
        this.EditableMap = EditableMap;
    }

    getCardDetailData(sellerId){
        return this.Restangular.one('merchant').one('carddetails',sellerId).getList();
    }
...
SellerCardService.$inject = ['Restangular', 'EditableMap'];
